...
app = FastAPI(
    ...
    version="1.0.0",
    lifespan=lifespan,
    docs_url=None,  # 默认docs用jsdelivr CDN，国内不可达，下方用镜像CDN自定义
)
...
async def custom_swagger_ui():
    ...
    return get_swagger_ui_html(
        ...
        swagger_js_url="https://registry.npmmirror.com/swagger-ui-dist/5.17.14/files/swagger-ui-bundle.js",
        swagger_css_url="https://registry.npmmirror.com/swagger-ui-dist/5.17.14/files/swagger-ui.css",
    )
